...
<nav className="bg-gray-900">
  <div className="flex space-x-4">
    <a href="#" className="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium" aria-current="page">Twitter Analytics</a>
  ...
  <form onSubmit={submitForm}>   
    ...
    <div className="relative">
        ...
        <button type="submit"  className="bg-blue-900 hover:bg-blue-900 text-white font-bold py-2 px-4 border border-blue-800 rounded">Search</button>
    </div>
</form>
</div>
</nav>
